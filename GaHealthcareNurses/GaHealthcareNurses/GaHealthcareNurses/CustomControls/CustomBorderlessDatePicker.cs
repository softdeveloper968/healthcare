...
{
    public class CustomBorderlessDatePicker : DatePicker
    {
        /// <summary>
        ...
        /// Die BinableProperty
        /// </summary>
        public static readonly BindableProperty NullableDateProperty = BindableProperty.Create<CustomBorderlessDatePicker, DateTime?>(i => i.NullableDate, null, BindingMode.TwoWay, null, NullableDateChanged);
        /// <summary>
        ...
        /// </summary>
        public static readonly BindableProperty NullTextProperty = BindableProperty.Create<CustomBorderlessDatePicker, string>(i => i.NullText, default(string), BindingMode.TwoWay);
        /// <summary>
        ...
        /// Die BindableProperty
        /// </summary>
        public static readonly BindableProperty DisplayBorderProperty = BindableProperty.Create<CustomBorderlessDatePicker, bool>(i => i.DisplayBorder, default(bool), BindingMode.TwoWay);
        /// <summary>
        ...
        /// </summary>
        public CustomBorderlessDatePicker()
        {
        ...
        {
            var customDatePicker = obj as CustomBorderlessDatePicker;
