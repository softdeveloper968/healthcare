...
using GaHealthcareNurses.Droid.Dependencies;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;
using Android.Graphics;
using GaHealthcareNurses.Interfaces;

[assembly: Xamarin.Forms.Dependency(typeof(MediaService))] 
namespace GaHealthcareNurses.Droid.Dependencies
{
    public class MediaService : IMediaService
    {
        ...
        public static Bitmap GetResizedBitmap(Bitmap bm, int orientation)
        {
            ...
            int rotate = 0;
            Android.Media.ExifInterface exif = new Android.Media.ExifInterface(Helpers.AppGlobalConstants.imgFilePath);
